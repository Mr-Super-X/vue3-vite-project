...
> ✅ Sidebar 菜单渲染已在 v3 实现（2026-07-24）：从 `router.getRoutes()` 自动派生 + 多级递归 + i18n 标题解析 + 折叠态联动。详见 `src/components/layout/Sidebar.vue`（338 行，含设计取舍注释）与 `docs/audit/2026-07-24-v3-usability-review.md` §1.1 P0-1。
